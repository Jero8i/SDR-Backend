...
public class ReservationMocks
{
    ...
    {   
        Reservations = new List<Reservation> {
            ...
            new Reservation(1, cm.Customers[1], sm.AvailableServices[1], new DateTime(2023, 7, 1), State.CANCELADA, 2, ""),
            new Reservation(2, cm.Customers[2], sm.AvailableServices[2], new DateTime(2023, 7, 1), State.PLANIFICADA, 3, ""),
